 ...
 */
function applyEdit(content, oldText, newText, lineNumber) {
...
export const editFileTool = defineTool('edit_file', 'Edit a file by replacing text. Supports exact text replacement or line-based edits. Creates a backup before editing.', {
    type: 'object',
    properties: {
        path: {
            type: 'string',
