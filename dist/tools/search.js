...
async function searchInFile(filePath, pattern, caseSensitive) {
...
async function searchInDirectory(dirPath, pattern, caseSensitive, results, depth = 0, maxDepth = 5) {
...
export const searchTextTool = defineTool('search_text', 'Search for text patterns in files within a directory. Supports regex patterns. Returns matching lines with file names and line numbers.', {
    type: 'object',
    properties: {
        pattern: {
            type: 'string',
