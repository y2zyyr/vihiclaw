...
export const writeFileTool = defineTool('write_file', 'Write content to a file at the specified path. Creates the file if it does not exist, overwrites if it does.', {
    type: 'object',
    properties: {
        path: {
            type: 'string',
